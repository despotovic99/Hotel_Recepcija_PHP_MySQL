...
if(isset($_POST['broj']) && $_POST['broj']!="" &&
    ...
    if(HotelskaSoba::azuriraj($conn,$broj,$sprat,$brojKreveta,$kuhinja,$terasa,$minibar,$sifraHotela,$sifra)){
        echo "Uspesno azurirana hotelska soba";
    }else{
        echo "Neuspesno azurirana hotelska soba";
    }
